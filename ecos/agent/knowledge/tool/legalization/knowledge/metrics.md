...
**Boundary:** legalization currently publishes no stage-specific numeric comparison metric; shared database facts are context, not proof of stage success or timing improvement.
