...
def test_phase8_runner_loads_hash_bound_six_design_manifest(tmp_path) -> None:
    ...
    designs = []
    design_ids = [f"d{i}" for i in range(6)]
    ...
    payload = {
        "schema_version": "ecos.frozen_design_manifest.v3",
