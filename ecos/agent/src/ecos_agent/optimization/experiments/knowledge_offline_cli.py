"""CLI for the frozen-context offline knowledge pilot."""
...
def main(default_ecc_bin: Path, provider_type: Callable[..., Any]) -> int:
    ...
    parser.add_argument("--ecc-bin", type=Path, default=default_ecc_bin)
