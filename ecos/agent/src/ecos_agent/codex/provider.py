...
class CodexAppServerProposalProvider(CodexThreadManagementMixin):
    ...
    def propose_v2(
        ...
        system = (
            ...
            "Prefer a knowledge claim: when supported_action_view covers the chosen knob and "
            "direction, cite its complete claim, binding, knob, direction, and hash; leave all "
            "claim and binding fields null only when no supplied entry covers the action. "
