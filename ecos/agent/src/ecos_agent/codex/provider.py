    ...
    def propose_optimization_objective(self, natural_language_goal: str) -> dict[str, Any]:
        ...
        proposal = self._proposal(
            ...
            (
                ...
                "Use route_dr_total_violation_count for DRC goals: it is the "
                "routed design-rule violation count and the DRC decision "
                "metric. The signoff iDRC drc_count is excluded from "
                "optimization decisions because it flags standard-cell "
                "obstruction shapes against power rails at every cell row. "
