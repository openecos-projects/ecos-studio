...
from ecos_agent.knowledge.bundle import KnowledgeAnswer, KnowledgeBundle, KnowledgeEntity
...
def _knowledge_root() -> Path:
    source_root = Path(__file__).parents[3] / "knowledge"
    return source_root if source_root.is_dir() else Path(__file__).parent
