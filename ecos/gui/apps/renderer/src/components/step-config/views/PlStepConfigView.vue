      ...
      <div class="sc-pro-hero__body">
        ...
        <div class="sc-pro-grid mt-2">
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).num_threads"
              size="small"
              :use-grouping="false"
              class="w-full"
            />
          ...
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).info_iter_num"
              size="small"
              :use-grouping="false"
              class="w-full"
            />
          ...
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).ignore_net_degree"
              size="small"
              :use-grouping="false"
              class="w-full"
            />
          ...
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).max_length_constraint"
              size="small"
              :use-grouping="false"
              class="w-full"
            />
          ...
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).is_max_length_opt"
              size="small"
              :min="0"
              :max="1"
              :use-grouping="false"
          ...
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).is_timing_effort"
              size="small"
              :min="0"
              :max="1"
              :use-grouping="false"
          ...
          <div class="field">
            ...
            <InputNumber
              fluid
              v-model="(pl() as Record<string, number>).is_congestion_effort"
              size="small"
              :min="0"
              :max="1"
              :use-grouping="false"
    ...
    <section class="sc-pro-section">
      <div class="sc-pro-section__head">
        ...
        <div class="sc-pro-section__titles">
          ...
          <div class="sc-pro-section__desc">
            Global placement: wirelength, density, and Nesterov blocks
          </div>
        </div>
      </div>
      <div class="sc-pro-section__body space-y-3">
        <div class="field sc-pro-grid--1 max-w-xs">
          ...
          <InputNumber
            fluid
            v-model="(gp() as Record<string, number>).global_right_padding"
            size="small"
            :use-grouping="false"
            class="w-full"
          />
        ...
        <div class="sc-pro-subpanel">
          ...
          <div class="sc-pro-grid">
            <div
              v-for="key in Object.keys((gp().Wirelength as object) ?? {}).sort()"
              :key="key"
              class="field"
            >
              <label>{{ key }}</label>
        ...
        <div class="sc-pro-subpanel">
          ...
          <div class="sc-pro-grid">
            <div
              v-for="key in Object.keys((gp().Density as object) ?? {}).sort()"
              :key="key"
              class="field"
            >
              <label>{{ key }}</label>
        ...
        <div class="sc-pro-subpanel">
          ...
          <div class="sc-pro-grid">
            <div
              v-for="key in Object.keys((gp().Nesterov as object) ?? {}).sort()"
              :key="key"
              class="field"
            >
              <label>{{ key }}</label>
    ...
    <section class="sc-pro-section">
      ...
      <div class="sc-pro-section__body">
        <div class="field max-w-xs">
          ...
          <InputNumber
            fluid
            v-model="(buf() as Record<string, number>).max_buffer_num"
            size="small"
            :use-grouping="false"
            class="w-full"
          />
        ...
        <div class="field min-w-0">
          ...
          <div class="w-full min-w-0 space-y-1">
            ...
            <button
              type="button"
              class="sc-pro-btn"
              @click="(buf().buffer_type as string[]).push('')"
            >
    ...
    <section class="sc-pro-section">
      ...
      <div class="sc-pro-section__body sc-pro-grid">
        <div v-for="key in Object.keys(lg()).sort()" :key="'lg-' + key" class="field">
          ...
          <InputNumber
            fluid
            v-model="(lg() as Record<string, number>)[key]"
            size="small"
            :use-grouping="false"
            class="w-full"
          />
    ...
    <section class="sc-pro-section">
      ...
      <div class="sc-pro-section__body space-y-3">
        <div class="field max-w-xs">
          ...
          <InputNumber
            fluid
            v-model="(filler() as Record<string, number>).min_filler_width"
            size="small"
            :use-grouping="false"
            class="w-full"
          />
        ...
        <div class="field min-w-0">
          ...
          <div class="w-full min-w-0 space-y-1">
            ...
            <button
              type="button"
              class="sc-pro-btn"
              @click="(filler().first_iter as string[]).push('')"
            >
              <i class="ri-add-line"></i>
            </button>
          </div>
        ...
        <div class="field min-w-0">
          ...
          <div class="w-full min-w-0 space-y-1">
            ...
            <button
              type="button"
              class="sc-pro-btn"
              @click="(filler().second_iter as string[]).push('')"
            >
              <i class="ri-add-line"></i>
            </button>
          </div>
