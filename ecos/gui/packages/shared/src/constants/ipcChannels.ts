export const desktopApiIpcChannels = {
  ...
  appGetQuickStartResources: 'app:get-quick-start-resources',
  ...
  projectManagementReadFrontendWorkspaceTexts:
    'project-management:read-frontend-workspace-texts',
  ...
  designRuntimeWorkspaceStepOutputs: 'design-runtime:workspace-step-outputs',
  ...
  agentProfileUpsert: 'agent:profile-upsert',
  agentProfileDelete: 'agent:profile-delete',
  agentProfileSelect: 'agent:profile-select',
  agentProfileSetApiKey: 'agent:profile-set-api-key',
