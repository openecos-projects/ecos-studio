export const desktopApiIpcChannels = {
  ...
  eccWorkspaceDescribeSpec: 'ecc:workspace-describe-spec',
  eccWorkspaceValidateSpec: 'ecc:workspace-validate-spec',
  ...
  eccRuntimeOpenArtifact: 'ecc:runtime-open-artifact',
