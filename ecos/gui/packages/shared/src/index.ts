...
export type {
  ...
  DesktopAgentInteractionKind,
  DesktopAgentInteractionOption,
  DesktopAgentInteractionPayload,
  DesktopAgentInteractionPurpose,
  DesktopAgentInteractionRequest,
  DesktopAgentInteractionStatus,
  ...
  DesktopAgentOperationAssociationCommand,
